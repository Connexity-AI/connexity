...
export const ExpectedToolCallSchema = {
    properties: {
        ...
        mock_responses: {
            ...
            description: 'Ordered mock responses consumed sequentially during platform agent simulation. First entry whose expected_params partially matches is popped and returned.'
        }
    },
    type: 'object',
    required: [
...
export const RunConfig_InputSchema = {
    properties: {
        ...
        evaluation_engine: {
            ...
            title: 'Evaluation Engine',
            description: 'Engine that drives the eval: connexity (in-process simulator + judge), retell (Retell web call), or custom_url (user-provided endpoint).',
            discriminator: {
                propertyName: 'kind',
                mapping: {
                    connexity: '#/components/schemas/ConnexityEngineConfig',

...
export class VoiceSimulationsService {
  /**
   * Submit Voice Simulation Results
   */
  public static voiceSimulationsSubmitVoiceSimulationResults<ThrowOnError extends boolean = false>(
    options: Options<VoiceSimulationsSubmitVoiceSimulationResultsData, ThrowOnError>
  ) {
    return (options.client ?? client).post<
      VoiceSimulationsSubmitVoiceSimulationResultsResponses,
      VoiceSimulationsSubmitVoiceSimulationResultsErrors,
  ...
  /**
   * Get Voice Simulation Job
   */
  public static voiceSimulationsGetVoiceSimulationJob<ThrowOnError extends boolean = false>(
    options: Options<VoiceSimulationsGetVoiceSimulationJobData, ThrowOnError>
  ) {
    return (options.client ?? client).get<
      VoiceSimulationsGetVoiceSimulationJobResponses,
      VoiceSimulationsGetVoiceSimulationJobErrors,

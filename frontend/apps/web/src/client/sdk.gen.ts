...
export class AgentsService {
     ...
     */
    public static listAgentEvaluationEngines<ThrowOnError extends boolean = false>(options: Options<AgentsListAgentEvaluationEnginesData, ThrowOnError>) {
        return (options.client ?? client).get<AgentsListAgentEvaluationEnginesResponses, AgentsListAgentEvaluationEnginesErrors, ThrowOnError>({
            security: [{
                    in: 'cookie',
                    name: 'auth_cookie',
                    type: 'apiKey'
...
export class EvalConfigsService {
     ...
     */
    public static evalConfigsTestEvaluationEngine<ThrowOnError extends boolean = false>(options: Options<EvalConfigsTestEvaluationEngineData, ThrowOnError>) {
        return (options.client ?? client).post<EvalConfigsTestEvaluationEngineResponses, EvalConfigsTestEvaluationEngineErrors, ThrowOnError>({
            security: [{
                    in: 'cookie',
                    name: 'auth_cookie',
                    type: 'apiKey'
